/**
 * Model-facing result rendering for the nu tool — the nushell twin of
 ...
 * results.
 *
 * @module @deepseek-ai/dsh-tool-nu/render
 */
...
export interface RenderableNuResult {
 ...
 */
export function renderNuResult(
  result: RenderableNuResult,
 ...
 */
export function renderNuProcessRead(
