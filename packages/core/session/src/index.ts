...
export { deriveEventMessage, foldSurface, isAppendSurfaceEvent, isDeepEqualJson, isReplacementSurfaceEvent, isSurfaceEvent, isSurfaceEligibleType } from './surface.ts'
